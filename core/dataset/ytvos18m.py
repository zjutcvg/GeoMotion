...
class MotionSegmentationDatasetYTVOS(Dataset):
    """
    ...
    def __init__(self, data_dir, split, transform=None, 
        ...
        self.sample_list = [
            ...
            if os.path.isdir(os.path.join(self.data_dir, 'JPEGImages', item))
        ]
        # print(os.listdir(osp.join(self.data_dir, 'JPEGImages')))
        ...
        for seq_name in tqdm(self.sample_list, desc=f"Validating data for '{split}' split"):
            # print(seq_name)
            train_set = ["0a275e7f12", "0b285c47f6", "0b1627e896", "0f74ec5599", "0f202e9852", "0f9683715b", "0fc958cde2", "1dfbe6f586", "1f3876f8d0", "2e42410932", "2f17e4fc1e", "2f710f66bd", "03e2b57b0e", "11cbcb0b4d", "11e53de6f2", "11feabe596", "14a6b5a139", "3113140ee8", "19e8bc6178", "0065b171f9", "115ee1072c", "258b3b33c6", "1233ac8596", "02264db755", "04194e1248", "04667fabaa", "39d584b09f", "2125235a49", "3b512dad74", "3cc6f90cb2", "3cdf03531b", "3db907ac77", "3e2845307e", "3ea4c49bbe", "3f3b15f083", "3fff16d112", "4a885fa3ef", "4aa2e0f865", "4c397b6fd4", "4c7710908f", "4ca2ffc361", "4dfaee19e5", "4e7a28907f", "4f37e86797", "4fffec8479", "39bc49a28c", "346aacf439", "404d02e0c0", "472da1c484", "4894b3b9ea", "35195a56a1", "47269e0499", "450787ac97", "31539918c4", "1cb44b920d", "1d6ff083aa", "2e2bf37e6d", "08d50b926c", "22f02efe3a", "3ae2deaec2", "3bb4e10ed7", "3e3a819865", "4d67c59727", "02d28375aa", "0c3a04798c", "0cfe974a89", "0d97fba242", "0f17fa6fcb", "2a18873352", "2d03593bdc", "18bad52083", "00917dcfc4", "2f680909e6", "005a527edd", "05a569d8aa", "07a11a35e8", "10eced835e", "11a0c3b724", "16afd538ad", "0a8c467cc3", "20c6d8b362", "26ddd2ef12", "045f00aed2", "101caff7d4", "142d2621f5", "125d1b19dd", "211bc5d102", "224e7c833e", "2481ceafeb", "07129e14a4", "013099c098", "04474174a4", "0693719753", "37d4ae24fc", "3ab9b1a85a", "4350f3ab60", "3beef45388", "3c5ff93faf", "3e7d2aeb07", "3e680622d7", "3ec273c8d5", "3efc6e9892", "3f0b0dfddd", "499bf07002", "4a4b50571c", "4a6e3faaa1", "4a088fe99a", "4b19c529fb", "4b97cc7b8d", "4e824b9247", "30dbdb2cd6", "0eefca067f", "36f5cc68fd", "357a710863", "365f459863", "375a49d38f", "377db65f60", "446b8b5f7a", "456fb9362e", "1e1a18c45a"]
            if seq_name not in train_set:
                continue
        ...
        print(f"YTMOS Loaded {len(self.sample_list)} valid sequences for '{split}' split")
