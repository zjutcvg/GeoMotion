...
class MotionSegmentationDatasetDAVIS(Dataset):
    """
    ...
    def __init__(self, data_dir, split, transform=None, 
        ...
        self.sample_list = [
            item for item in sorted(os.listdir(osp.join(self.data_dir, 'JPEGImages/480p')))
        ...
        for seq_name in tqdm(self.sample_list, desc=f"Validating data for '{split}' split"):
            ...
            img_dir = osp.join(self.data_dir, 'JPEGImages/480p', seq_name)
            mask_dir = osp.join(self.data_dir, 'Annotations/480p',seq_name)
