...
class MotionSegmentationDatasetGOT(Dataset):
    """
    ...
    def __init__(self, data_dir, split, transform=None, 
        ...
        for seq_name in tqdm(self.sample_list, desc=f"Validating data for '{split}' split"):
            ...
            mask_dir = osp.join(self.data_dir, seq_name, "masks")
...
def test_motion_seg_dataset():
    ...
    """
    cfg = MotionSegConfig()
    cfg.data_dir = "/data0/hexiankang/code/SegAnyMo/data/GOT10k/GOT-10k_Train_split_01"  # Update this path
    
    # try:
    # Create dataset
    dataset = MotionSegmentationDatasetGOT(
        data_dir=cfg.data_dir,
        split="train",
        img_size=518,
        sequence_length=12,
